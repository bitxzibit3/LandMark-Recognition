...
- вид сети, который вы хотите использовать.

  При первом запуске скрипта файлы, содержащие веса сети, будут загружены из интернета. Соответственно, при последующих запусках будут использоваться уже скачанные файлы.
  Сейчас доступно две сети: 
